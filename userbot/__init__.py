...
async def checking():
    gocheck = str(pybase64.b64decode("QEx5bnhTdXBwb3J0cw=="))[2:15]
    checker = str(pybase64.b64decode("aHR0cHM6Ly90Lm1lL2Frc3Bhc3Rl"))[2:16]
    try:
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**𝐋𝐘𝐍𝐗-𝐔𝐒𝐄𝐑𝐁𝐎𝐓 ᴅᴀʜ  ᴀᴋᴛɪꜰ  ʏᴀ  ᴄʀᴏᴛ💫**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 2.0\n━━━━━━━━━━━━━━━━━━━\n❃ **sᴜᴘᴘᴏʀᴛ​ :** @LynxSupports\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @Unsupportesd \n━━━━━━━━━━━━━━━━━━━")
    return
